...
public class ChooseInterestsAdapter
    ...
    private List<TDCCategory> mSelectedCategories;
     ...
     */
    public void setCategories(@NonNull List<TDCCategory> all, @NonNull List<UserCategory> selected){
     ...
     */
    public TDCCategory getItem(int position){
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder rawHolder, int position){
        if (getItemViewType(position) == VIEW_TYPE_HEADER){
            ...
            TDCCategory category = getItem(position - 1);
            holder.itemView.setVisibility(View.GONE);
    ...
    class CategoryViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, Animation.AnimationListener{
        ...
        public void onClick(final View view){
            ...
            TDCCategory category = getItem(getAdapterPosition() - 1);
    ...
    public interface OnCategoriesSelectedListener{
         ...
         */
        void onCategoriesSelected(List<TDCCategory> selection, List<UserCategory> original);
    }
}
