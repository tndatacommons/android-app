...
public class ChooseGoalAdapter extends ArrayAdapter<Goal> {
    public interface ChooseGoalAdapterListener {
    ...
    private ChooseGoalAdapterListener mCallback;

    public ChooseGoalAdapter(Context context, int resource,
                             List<Goal> objects, ChooseGoalAdapterListener callback) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = vi.inflate(R.layout.list_item_choose_goal, null);
        }
